...
const G = (kind: AlertKind, meaning: string, impact: string, steps: string[]): AlertGuidance => ({
  kind,
  meaning,
  impact,
  steps,
...
const GUIDANCE: Record<string, AlertGuidance> = {
  ...
  contrato_80: G(
    ...
    [
      "Abra Contratos e confira o consumo por item.",
      "Avalie aditivo de valor ou novo processo.",
      "Se a execução está dentro do planejado, encerre o alerta com justificativa.",
    ],
  ),
  contrato_90: G(
    "orientativo",
    ...
    [
      "Confira o saldo por item em Contratos.",
      "Providencie aditivo ou nova contratação.",
      "Encerre o alerta com justificativa se a decisão já foi tomada.",
    ],
  ),
  contrato_esgotado: G(
    "corretivo",
    ...
    [
      "Registre aditivo de acréscimo, ou",
      "Encerre o contrato e vincule as operações a outro contrato vigente.",
    ],
  ),
  contrato_vencido: G(
    "corretivo",
    ...
    [
      "Registre o aditivo de prorrogação com a nova data, ou",
      "Altere a situação do contrato para encerrado.",
    ],
  ),
  cotacao_insuficiente: G(
    ...
    [
      "Convide novas empresas cadastradas pelo órgão e aguarde proposta, ou",
      "Registre no processo a justificativa prevista para menos de 3 propostas.",
      "Com a justificativa registrada, encerre o alerta informando-a.",
    ],
  ),
  os_atrasada: G(
    "corretivo",
    ...
    [
      "Abra a ordem de serviço e atualize a execução.",
      "Conclua ou cancele a ordem quando o serviço terminar.",
    ],
  ),
  saldo_insuficiente: G(
    ...
    [
      "Verifique qual saldo faltou na mensagem do alerta.",
      "Reforce empenho, cota ou contrato.",
      "Encerre o alerta após tratar o caso.",
    ],
  ),
};
