...
export const MODULES: ModuleDef[] = [
  ...
  m("rede-credenciada", "Oficinas e rede credenciada", "Rede credenciada e compras"),
  m("credenciados", "Credenciados e cartão virtual", "Rede credenciada e compras"),
  m("portal-credenciado", "Portal do credenciado", "Rede credenciada e compras"),
  m("mapa-rede", "Mapa da rede", "Rede credenciada e compras"),
  m("cotacoes", "Cotações", "Rede credenciada e compras", ["/cotacao/"]),
  m("ordens-servico", "Ordens de Serviço", "Rede credenciada e compras", ["/ordem-servico/"]),
  m("ofp", "Ordens de fornecimento (OFP)", "Rede credenciada e compras"),
