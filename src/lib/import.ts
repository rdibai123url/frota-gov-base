...
import { isValidCNPJ, isValidCPF, onlyDigits, parseBRNumber } from "@/lib/format";
...
export type RefKind =
  "unit" | "vehicle" | "supplier" | "driver" | "fuel" | "contract" | "cost_center";
...
export const IMPORT_MODULES: ImportModule[] = [
    ...
    fields: [
      {
        ...
        type: "text",
        required: true,
        aliases: ["unidade", "secretaria", "nome"],
      },
      { key: "acronym", label: "Sigla", type: "text", aliases: ["sigla", "abreviacao"] },
      {
        ...
        type: "enum",
        options: UNIT_TYPES,
        aliases: ["tipo", "tipo_unidade"],
      },
      {
        key: "manager_name",
        label: "Responsável",
        type: "text",
        aliases: ["responsavel", "gestor", "secretario"],
      },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "chassis", label: "Chassi", type: "text", aliases: ["chassi", "chassis"] },
      {
        ...
        label: "Patrimônio",
        type: "text",
        aliases: ["patrimonio", "tombamento", "bem"],
      },
      ...
      { key: "model", label: "Modelo", type: "text", aliases: ["modelo"] },
      {
        ...
        type: "int",
        aliases: ["ano_fabricacao", "ano_fab"],
      },
      ...
      { key: "color", label: "Cor", type: "text", aliases: ["cor"] },
      {
        ...
        type: "text",
        aliases: ["tipo", "especie", "categoria"],
      },
      { key: "fuel_type", label: "Combustível", type: "text", aliases: ["combustivel"] },
      {
        ...
        type: "liters",
        aliases: ["tanque", "capacidade"],
      },
      {
        key: "current_km",
        label: "KM atual",
        type: "number",
        aliases: ["km", "hodometro", "quilometragem"],
      },
    ...
    fields: [
      {
        ...
        type: "text",
        required: true,
        aliases: ["nome", "condutor", "motorista"],
      },
      { key: "cpf", label: "CPF", type: "cpf", aliases: ["cpf", "documento"] },
      {
        ...
        label: "Matrícula",
        type: "text",
        aliases: ["matricula", "registro"],
      },
      {
        key: "bond_type",
        label: "Vínculo",
        type: "enum",
        options: DRIVER_BONDS,
        aliases: ["vinculo", "tipo_vinculo"],
      },
      {
        key: "license_number",
        label: "CNH",
        type: "text",
        aliases: ["cnh", "habilitacao", "registro_cnh"],
      },
      {
        key: "license_categories",
        label: "Categorias da CNH",
        type: "text",
        aliases: ["categoria", "categorias", "categoria_cnh"],
        hint: "Separe por vírgula: A,B,D",
      },
      {
        key: "license_expiry",
        label: "Validade da CNH",
        type: "date",
        aliases: ["validade", "validade_cnh", "vencimento_cnh"],
      },
  ...
  },
  {
    ...
    description:
      "Postos, oficinas e demais fornecedores. Os contratos podem ser vinculados depois.",
    order: 4,
    depends: [],
    ...
    fields: [
      {
        ...
        type: "text",
        required: true,
        aliases: ["razao_social", "nome", "fornecedor"],
      },
      {
        key: "trade_name",
        label: "Nome fantasia",
        type: "text",
        aliases: ["fantasia", "nome_fantasia"],
      },
    ...
    fields: [
      {
        ...
        type: "text",
        required: true,
        aliases: ["produto", "combustivel", "nome"],
      },
      { key: "acronym", label: "Sigla", type: "text", aliases: ["sigla"] },
      {
        ...
        label: "Categoria",
        type: "enum",
        options: PRODUCT_CATEGORIES_IMPORT,
        aliases: ["categoria", "tipo"],
      },
      {
        key: "measure_unit",
        label: "Unidade de medida",
        type: "text",
        aliases: ["unidade", "unidade_medida", "um"],
      },
    ],
  },
  {
    ...
    fields: [
      {
        ...
        type: "text",
        required: true,
        aliases: ["contrato", "numero", "n_contrato"],
      },
      {
        key: "object",
        label: "Objeto",
        type: "text",
        required: true,
        aliases: ["objeto", "descricao"],
      },
      {
        key: "process_number",
        label: "Processo administrativo",
        type: "text",
        aliases: ["processo", "n_processo"],
      },
      {
        key: "modality",
        label: "Modalidade",
        type: "enum",
        options: CONTRACT_MODALITIES,
        aliases: ["modalidade", "licitacao"],
      },
      refSupplier(),
      {
        key: "cnpj",
        ...
        type: "cnpj",
        aliases: ["cnpj", "cnpj_contratado"],
      },
      {
        key: "signed_at",
        label: "Data de assinatura",
        type: "date",
        aliases: ["assinatura", "data_assinatura"],
      },
      {
        key: "valid_from",
        ...
        type: "date",
        required: true,
        aliases: ["inicio_vigencia", "vigencia_inicio", "inicio"],
      },
      {
        key: "valid_to",
        ...
        type: "date",
        required: true,
        aliases: ["fim_vigencia", "vigencia_fim", "termino"],
      },
      {
        key: "initial_value",
        ...
        type: "money",
        required: true,
        aliases: ["valor", "valor_contrato", "valor_inicial"],
      },
      {
        key: "status",
        label: "Situação",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "exercise", label: "Exercício", type: "int", aliases: ["exercicio", "ano"] },
      {
        ...
        type: "date",
        required: true,
        aliases: ["data", "emissao", "data_emissao"],
      },
      {
        key: "kind",
        label: "Tipo",
      ...
      refUnit(),
      {
        ...
        type: "text",
        aliases: ["dotacao", "dotacao_orcamentaria"],
      },
      {
        key: "resource_source",
        label: "Fonte de recurso",
        type: "text",
        aliases: ["fonte", "fonte_recurso"],
      },
      {
        key: "expense_element",
        label: "Elemento de despesa",
        type: "text",
        aliases: ["elemento", "elemento_despesa"],
      },
      {
        key: "status",
        label: "Situação",
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: "fueled_at",
        label: "Data/hora do abastecimento",
        type: "datetime",
        required: true,
        aliases: ["data", "data_abastecimento", "data_hora"],
      },
      {
        key: "_fuel",
      ...
      },
      {
        ...
        type: "money",
        required: true,
        aliases: ["preco", "valor_unitario", "preco_litro"],
      },
      {
        key: "odometer_km",
        label: "Hodômetro (KM)",
      ...
      refUnit(),
      {
        ...
        label: "Condutor (nome)",
        type: "text",
        aliases: ["condutor", "motorista"],
      },
      {
        key: "invoice_number",
        label: "Documento fiscal",
        type: "text",
        aliases: ["nota", "cupom", "documento", "nf"],
      },
      {
        key: "document_kind",
        label: "Tipo de documento",
        type: "text",
        aliases: ["tipo_documento"],
      },
      { key: "notes", label: "Observações", type: "text", aliases: ["observacao", "obs"] },
    ],
  },
  {
    ...
    fields: [
      ...
      refDriver(),
      {
        ...
        type: "datetime",
        required: true,
        aliases: ["saida", "data_saida", "inicio"],
      },
      {
        key: "actual_return",
        label: "Retorno",
        type: "datetime",
        aliases: ["retorno", "data_retorno", "fim"],
      },
      ...
      { key: "destination", label: "Destino", type: "text", aliases: ["destino"] },
      {
        ...
        label: "Finalidade",
        type: "text",
        aliases: ["finalidade", "motivo", "objetivo"],
      },
      {
        key: "requester_name",
        label: "Solicitante",
        type: "text",
        aliases: ["solicitante", "requisitante"],
      },
      refUnit(),
      {
        key: "status",
  ...
  },
  {
    ...
    description:
      "Manutenções preventivas e corretivas já executadas. Não consome empenho nem cota.",
    order: 11,
    ...
    fields: [
      ...
      },
      {
        ...
        type: "datetime",
        required: true,
        aliases: ["data", "entrada", "data_entrada"],
      },
      {
        key: "exit_at",
        label: "Saída",
        type: "datetime",
        aliases: ["saida", "data_saida", "conclusao"],
      },
      {
        key: "services",
        ...
        type: "text",
        required: true,
        aliases: ["servico", "servicos", "descricao"],
      },
      { key: "odometer_km", label: "Hodômetro (KM)", type: "number", aliases: ["km", "hodometro"] },
      {
        ...
        label: "Mão de obra",
        type: "money",
        aliases: ["mao_de_obra", "servico_valor"],
      },
      ...
      { key: "other_value", label: "Outros valores", type: "money", aliases: ["outros"] },
      {
        ...
        type: "money",
        required: true,
        aliases: ["valor", "total", "valor_total"],
      },
      refSupplier(),
      refUnit(),
      {
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: "notice_number",
        label: "Número do auto/AIT",
        type: "text",
        required: true,
        aliases: ["auto", "ait", "numero", "notificacao"],
      },
      {
        key: "occurred_at",
        ...
        type: "datetime",
        required: true,
        aliases: ["data", "data_infracao"],
      },
      {
        key: "issuing_authority",
        label: "Órgão autuador",
        type: "text",
        aliases: ["orgao", "autuador", "detran"],
      },
      {
        key: "infraction_code",
        label: "Código da infração",
        type: "text",
        aliases: ["codigo", "enquadramento"],
      },
      ...
      { key: "location", label: "Local", type: "text", aliases: ["local", "endereco"] },
      {
        ...
        type: "money",
        required: true,
        aliases: ["valor", "valor_multa"],
      },
      {
        key: "due_date",
        label: "Vencimento",
        type: "date",
        aliases: ["vencimento", "data_vencimento"],
      },
      refDriver(),
      {
        key: "responsible_name",
        label: "Responsável indicado",
        type: "text",
        aliases: ["responsavel", "condutor_indicado"],
      },
      {
        key: "liability",
        label: "Responsabilidade",
        type: "enum",
        options: FINE_LIABILITY,
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "date",
        required: true,
        aliases: ["inicio", "vigencia_inicio"],
      },
      {
        key: "valid_to",
        label: "Fim da vigência",
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "date",
        required: true,
        aliases: ["data", "data_movimentacao"],
      },
      refUnit(),
      { key: "owner_name", label: "Proprietário", type: "text", aliases: ["proprietario"] },
      {
        key: "holder_name",
        label: "Detentor / responsável",
        type: "text",
        aliases: ["detentor", "responsavel"],
      },
      {
        key: "asset_code",
        label: "Patrimônio",
        type: "text",
        aliases: ["patrimonio", "tombamento"],
      },
      {
        key: "act_number",
        label: "Ato / documento",
        type: "text",
        aliases: ["ato", "portaria", "documento"],
      },
      { key: "odometer_km", label: "Hodômetro (KM)", type: "number", aliases: ["km", "hodometro"] },
    ...
    fields: [
      {
        ...
        type: "text",
        required: true,
        aliases: ["nome", "razao_social", "entidade"],
      },
      {
        key: "kind",
        label: "Tipo",
  ...
  },
  {
    ...
    label: "Diárias (RD)",
    description:
      "Requisições de diária já concedidas em sistema anterior. Registros legados, sem efeito orçamentário corrente.",
    order: 17,
    ...
    fields: [
      ...
      refVehicle(false),
      {
        ...
        type: "text",
        required: true,
        aliases: ["nome", "servidor", "beneficiario"],
      },
      {
        key: "beneficiary_role",
        label: "Cargo / função",
        type: "text",
        aliases: ["cargo", "funcao"],
      },
      ...
      { key: "origin_state", label: "UF de origem", type: "text", aliases: ["uf_origem"] },
      {
        ...
        type: "text",
        required: true,
        aliases: ["destino", "cidade_destino"],
      },
      { key: "destination_state", label: "UF de destino", type: "text", aliases: ["uf_destino"] },
      {
        ...
        type: "datetime",
        required: true,
        aliases: ["saida", "data_saida", "partida"],
      },
      {
        key: "return_at",
        label: "Data/hora de retorno",
        type: "datetime",
        aliases: ["retorno", "data_retorno"],
      },
      {
        key: "quantity",
        label: "Quantidade de diárias",
        type: "number",
        aliases: ["qtd", "quantidade", "diarias"],
      },
      {
        key: "unit_value",
        label: "Valor unitário",
        type: "money",
        aliases: ["valor_unitario", "valor_diaria"],
      },
      {
        key: "purpose",
        label: "Finalidade / motivo",
        type: "text",
        aliases: ["motivo", "finalidade", "objetivo"],
      },
      ...
      { key: "event_location", label: "Local do evento", type: "text", aliases: ["local"] },
      {
        ...
        type: "text",
        aliases: ["norma", "base_legal", "decreto"],
      },
      {
        key: "status",
        label: "Situação",
        type: "enum",
        options: DIARY_STATUS_IMPORT,
        aliases: ["situacao", "status"],
      },
      { key: "notes", label: "Observações", type: "text", aliases: ["observacao", "obs"] },
    ],
  },
  {
    ...
    fields: [
      ...
      { key: "expenses_value", label: "Despesas", type: "money", aliases: ["despesas", "custo"] },
      {
        ...
        label: "Situação",
        type: "enum",
        options: ACCIDENT_STATUS_IMPORT,
        aliases: ["situacao"],
      },
      {
        key: "reporter_name",
        label: "Comunicante",
        type: "text",
        aliases: ["comunicante", "responsavel"],
      },
      { key: "notes", label: "Observações", type: "text", aliases: ["observacao", "obs"] },
    ],
  },
  {
    ...
    fields: [
      ...
      {
        key: "performed_at",
        label: "Data/hora do serviço",
        type: "datetime",
        required: true,
        aliases: ["data", "data_servico", "data_limpeza"],
      },
      {
        key: "service_types",
        label: "Tipos de serviço (separados por ponto e vírgula)",
        type: "text",
        aliases: ["servicos", "tipo", "tipos"],
      },
      {
        key: "odometer_km",
        label: "Quilometragem",
        type: "number",
        aliases: ["km", "hodometro", "odometro"],
      },
      {
        key: "total_value",
        label: "Valor total",
        type: "money",
        aliases: ["valor", "valor_total", "custo"],
      },
      {
        key: "invoice_number",
        label: "Nota fiscal",
        type: "text",
        aliases: ["nf", "nota", "nota_fiscal"],
      },
      {
        key: "status",
        label: "Situação",
        type: "enum",
        options: CLEANING_STATUS_IMPORT,
        aliases: ["situacao"],
      },
      { key: "notes", label: "Observações", type: "text", aliases: ["observacao", "obs"] },
    ],
    ...
    fields: [
      {
        ...
        type: "text",
        required: true,
        aliases: ["razao_social", "nome", "oficina"],
      },
      ...
      { key: "contact_name", label: "Contato", type: "text", aliases: ["contato", "responsavel"] },
      {
        ...
        type: "text",
        aliases: ["especialidades", "servicos"],
      },
      {
        key: "coverage_area",
        label: "Área de cobertura",
        type: "text",
        aliases: ["cobertura", "regiao"],
      },
      {
        key: "status",
        label: "Situação",
        type: "enum",
        options: WORKSHOP_STATUS_IMPORT,
        aliases: ["situacao"],
      },
      { key: "notes", label: "Observações", type: "text", aliases: ["observacao", "obs"] },
    ],
  },
  {
    ...
    fields: [
      ...
      { key: "brand", label: "Marca", type: "text", aliases: ["marca", "fabricante"] },
      {
        ...
        label: "Referência",
        type: "text",
        aliases: ["referencia", "part_number"],
      },
  ...
  },
  {
    ...
    fields: [
      {
        key: "code",
        label: "Código / número de controle",
        type: "text",
        required: true,
        aliases: ["codigo", "numero"],
      },
      ...
      refSupplier(),
      {
        ...
        type: "money",
        aliases: ["valor", "valor_compra"],
      },
      { key: "purchase_date", label: "Data da compra", type: "date", aliases: ["data_compra"] },
      {
        key: "expected_life_km",
        label: "Vida útil prevista (km)",
        type: "number",
        aliases: ["vida_util", "km_previsto"],
      },
      {
        key: "accumulated_km",
        label: "Km acumulado",
        type: "number",
        aliases: ["km_acumulado", "km_rodado"],
      },
      {
        key: "status",
        label: "Situação",
        type: "enum",
        options: TIRE_STATUS_IMPORT,
        aliases: ["situacao"],
      },
      refVehicle(false),
  ...
  },
  {
    ...
    fields: [
      ...
      refVehicle(false),
      {
        ...
        type: "text",
        aliases: ["tipo_veiculo", "categoria"],
      },
      {
        key: "interval_km",
        label: "Intervalo (km)",
        type: "number",
        aliases: ["km", "intervalo_km"],
      },
      {
        key: "interval_hours",
        label: "Intervalo (horas)",
        type: "number",
        aliases: ["horas", "intervalo_horas"],
      },
      {
        key: "interval_months",
        label: "Intervalo (meses)",
        type: "int",
        aliases: ["meses", "intervalo_meses"],
      },
    ...
    fields: [
      {
        ...
        type: "text",
        required: true,
        aliases: ["cota", "nome", "descricao"],
      },
      {
        key: "quota_type",
        label: "Tipo de cota",
        type: "enum",
        options: QUOTA_TYPES_IMPORT,
        aliases: ["tipo"],
      },
      {
        key: "measure_unit",
      ...
      {
        key: "granted_amount",
        label: "Valor / quantidade concedida",
        type: "number",
        aliases: ["concedido", "valor", "quantidade"],
      },
      { key: "notes", label: "Observações", type: "text", aliases: ["observacao", "obs"] },
    ],
  },
...
export async function parseImportFile(file: File): Promise<ParsedFile> {
  ...
  if (/\.json$/i.test(file.name) || file.type === "application/json") {
    ...
    if (!Array.isArray(list)) {
      throw new Error(
        'JSON sem lista de registros. Use um array de objetos ou { "dados": [...] }.',
      );
    }
  ...
  for (const field of mod.fields) {
    ...
    const partial =
      ...
      headers.find(
        (h) =>
          !used.has(h) &&
          candidates.some((c) => c.length > 3 && (slug(h).includes(c) || c.includes(slug(h)))),
      );
    if (partial) {
...
export function downloadTemplate(mod: ImportModule) {
  ...
  sheet["!cols"] = header.map((h, i) => ({
    wch: Math.max(16, Math.min(42, Math.max(h.length, String(help[i]).length / 2))),
  }));
        ...
        case "int": {
          ...
          if (!n) {
            issues.push({
              ...
              label: field.label,
              value,
              reason: "Número inteiro inválido",
              level: "erro",
            });
            continue;
          }
        ...
        case "date": {
          ...
          if (!d) {
            issues.push({
              ...
              label: field.label,
              value,
              reason: "Data inválida (use dd/mm/aaaa)",
              level: "erro",
            });
            continue;
          }
        ...
        case "datetime": {
          ...
          if (new Date(d).getTime() > Date.now() + 86_400_000) {
            issues.push({
              ...
              label: field.label,
              value,
              reason: "Data futura em registro histórico",
              level: "aviso",
            });
          }
          normalized[field.key] = d;
        ...
        case "plate": {
          ...
          if (!/^[A-Z]{3}\d[A-Z0-9]\d{2}$/.test(plate)) {
            issues.push({
              ...
              label: field.label,
              value,
              reason: "Placa fora do padrão brasileiro",
              level: "erro",
            });
            continue;
          }
    ...
    if (mod.id === "utilizacoes" && normalized["start_km"] && normalized["end_km"]) {
      if (Number(normalized["end_km"]) < Number(normalized["start_km"])) {
        issues.push({
          field: "end_km",
          label: "KM final",
          value: normalized["end_km"]!,
          reason: "KM final menor que o inicial",
          level: "erro",
        });
      }
    }
    if (mod.id === "contratos" && normalized["valid_from"] && normalized["valid_to"]) {
      if (normalized["valid_to"]! < normalized["valid_from"]!) {
        issues.push({
          field: "valid_to",
          label: "Fim da vigência",
          value: normalized["valid_to"]!,
          reason: "Fim da vigência anterior ao início",
          level: "erro",
        });
      }
    }
