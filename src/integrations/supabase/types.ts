  ...
  public: {
    Tables: {
      ...
      compatibility_overrides: {
        ...
        Relationships: [
          {
            foreignKeyName: "compatibility_overrides_organization_id_fkey";
            columns: ["organization_id"];
            isOneToOne: false;
            referencedRelation: "organizations";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "compatibility_overrides_part_id_fkey";
            columns: ["part_id"];
            isOneToOne: false;
          ...
          {
            foreignKeyName: "compatibility_overrides_vehicle_id_fkey";
            columns: ["vehicle_id"];
            isOneToOne: false;
            referencedRelation: "vehicles";
            referencedColumns: ["id"];
      ...
      inventory_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "inventory_items_part_id_fkey";
            columns: ["part_id"];
            isOneToOne: false;
            referencedRelation: "parts_catalog";
            referencedColumns: ["id"];
      ...
      part_compatibilities: {
        ...
        Relationships: [
          {
            foreignKeyName: "part_compatibilities_organization_id_fkey";
            columns: ["organization_id"];
            isOneToOne: false;
            referencedRelation: "organizations";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "part_compatibilities_vehicle_id_fkey";
            columns: ["vehicle_id"];
            isOneToOne: false;
            referencedRelation: "vehicles";
            referencedColumns: ["id"];
      ...
      stock_movements: {
        Row: {
          ...
          created_by: string | null;
          document_number: string | null;
          expense_origin: Database["public"]["Enums"]["expense_origin"] | null;
          hour_meter: number | null;
          id: string;
        ...
        Relationships: [
          {
            foreignKeyName: "stock_movements_maintenance_record_id_fkey";
            columns: ["maintenance_record_id"];
            isOneToOne: false;
            referencedRelation: "maintenance_records";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "stock_movements_supply_order_id_fkey";
      ...
      stock_reservations: {
        ...
        Relationships: [
          {
            foreignKeyName: "stock_reservations_maintenance_record_id_fkey";
            columns: ["maintenance_record_id"];
            isOneToOne: false;
            referencedRelation: "maintenance_records";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "stock_reservations_supply_order_id_fkey";
            columns: ["supply_order_id"];
            isOneToOne: false;
            referencedRelation: "supply_orders";
            referencedColumns: ["id"];
      ...
      supply_order_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "supply_order_items_part_id_fkey";
            columns: ["part_id"];
            isOneToOne: false;
            referencedRelation: "parts_catalog";
            referencedColumns: ["id"];
      ...
      supply_orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "supply_orders_commitment_id_fkey";
            columns: ["commitment_id"];
            isOneToOne: false;
            referencedRelation: "commitments";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "supply_orders_contract_id_fkey";
            columns: ["contract_id"];
            isOneToOne: false;
            referencedRelation: "contracts";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "supply_orders_contract_item_id_fkey";
            columns: ["contract_item_id"];
            isOneToOne: false;
            referencedRelation: "contract_items";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "supply_orders_cost_center_id_fkey";
            columns: ["cost_center_id"];
            isOneToOne: false;
            referencedRelation: "cost_centers";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "supply_orders_organization_id_fkey";
            columns: ["organization_id"];
            isOneToOne: false;
            referencedRelation: "organizations";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "supply_orders_partner_id_fkey";
            columns: ["partner_id"];
            isOneToOne: false;
            referencedRelation: "accredited_partners";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "supply_orders_quota_id_fkey";
            columns: ["quota_id"];
            isOneToOne: false;
            referencedRelation: "quotas";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "supply_orders_quotation_id_fkey";
            columns: ["quotation_id"];
            isOneToOne: false;
            referencedRelation: "quotations";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "supply_orders_unit_id_fkey";
            columns: ["unit_id"];
            isOneToOne: false;
            referencedRelation: "units";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "supply_orders_vehicle_id_fkey";
            columns: ["vehicle_id"];
            isOneToOne: false;
            referencedRelation: "vehicles";
            referencedColumns: ["id"];
      ...
      webhook_endpoints: {
        Row: {
          ...
          last_status: Database["public"]["Enums"]["webhook_delivery_status"] | null;
          max_retries: number;
          name: string;
          organization_id: string;
          secret_name: string | null;
    ...
    Functions: {
      ...
      part_is_compatible: {
        Args: { _part: string; _vehicle: string };
        Returns: boolean;
      };
      ...
      stock_move: {
        Args: {
          _document?: string;
          _expense_origin?: Database["public"]["Enums"]["expense_origin"];
          _hour_meter?: number;
          ...
          _occurred_at?: string;
          _odometer?: number;
          _override_justification?: string;
          _part: string;
          _quantity: number;
          _reason?: string;
          _service_order?: string;
          _supply_order?: string;
          _target_warehouse?: string;
          _unit_value?: number;
          _vehicle?: string;
          _warehouse: string;
        };
      ...
      supply_order_issue: { Args: { _order: string }; Returns: undefined };
    ...
    Enums: {
      accident_kind:
        ...
        | "outro";
      accident_status:
        "registrado" | "em_apuracao" | "seguradora_acionada" | "reparo_autorizado" | "encerrado";
      alert_severity: "info" | "alerta" | "erro";
      alert_status: "aberto" | "resolvido";
      app_role:
        "super_admin" | "org_admin" | "fleet_manager" | "unit_manager" | "operator" | "auditor";
      ...
      asset_movement_kind:
        ...
        | "alienado"
        | "desativado";
      budget_movement_kind: "reserva" | "liberacao" | "consumo" | "estorno" | "suplementacao";
      ...
      contract_modality:
        ...
        | "outro"
        | "credenciamento";
      contract_status: "rascunho" | "vigente" | "suspenso" | "encerrado" | "rescindido";
      diary_proof_status:
      ...
      diary_status:
        ...
        | "rejeitada"
        | "cancelada";
      driver_bond: "efetivo" | "comissionado" | "contratado" | "terceirizado" | "outro";
      entity_kind: "pf" | "pj";
      expense_origin:
        | "contrato"
        | "compra_direta"
      ...
      fine_status:
        ...
        | "cancelada";
      fuel_auth_status:
        "pendente" | "autorizada" | "utilizada_parcial" | "utilizada" | "expirada" | "cancelada";
      ...
      integration_status: "nao_configurado" | "configurado" | "ativo" | "erro" | "desativado";
      invitation_status: "convidada" | "respondida" | "recusada" | "sem_resposta";
      ...
      maintenance_request_status:
        "aberta" | "em_analise" | "aprovada" | "em_manutencao" | "concluida" | "cancelada";
      market_value_origin: "manual" | "importada" | "api";
      obligation_status: "pendente" | "quitada" | "vencida" | "nao_aplicavel" | "cancelada";
      org_type:
        "prefeitura" | "camara" | "consorcio" | "autarquia" | "fundacao" | "secretaria" | "outro";
      partner_kind: "abastecimento" | "manutencao" | "pecas" | "pneus" | "higienizacao";
      partner_status: "ativo" | "suspenso" | "inativo";
      partner_user_role: "responsavel" | "operador";
      partner_user_status: "ativo" | "bloqueado" | "inativo";
      proposal_status: "recebida" | "desclassificada" | "selecionada" | "nao_selecionada";
      quota_type: "financeira" | "quantitativa";
      quotation_status: "rascunho" | "aberta" | "em_analise" | "encerrada" | "cancelada";
      reopen_request_status: "aberto" | "em_analise" | "aprovado" | "rejeitado" | "executado";
      ...
      supply_order_status:
        ...
        | "cancelada";
      tire_movement_kind:
        "entrada" | "instalacao" | "retirada" | "reparo" | "recapagem" | "descarte" | "baixa";
      tire_status: "estoque" | "instalado" | "em_reparo" | "recapagem" | "descartado" | "baixado";
      transparency_integration_mode: "desativada" | "api" | "webhook" | "arquivo";
      transparency_period_status:
        ...
        | "reaberta"
        | "erro_integracao";
      unit_type: "secretaria" | "departamento" | "diretoria" | "coordenacao" | "unidade" | "outro";
      usage_status: "solicitada" | "autorizada" | "em_uso" | "concluida" | "cancelada";
...
export const Constants = {
  public: {
    Enums: {
      ...
      contract_status: ["rascunho", "vigente", "suspenso", "encerrado", "rescindido"],
      diary_proof_status: ["em_elaboracao", "entregue", "em_conferencia", "aprovada", "rejeitada"],
      diary_status: [
        "rascunho",
        "solicitada",
        "em_analise",
